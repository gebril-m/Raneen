    ...
    jQuery("#latest-news-slider .slider-items").owlCarousel({
        ...
        ******************************************/
        ...
        jQuery('.mega-menu-title').on('click', function() {
            if (jQuery('.noneis').is(':visible')) {
                jQuery('.noneis').slideUp();
            } else {
                jQuery('.noneis').slideDown();
            }
        });
...
$( function() {
  ...
  $(window).ready(function () {
	"use strict";
	$(".overlay-loading .sk-cube-grid").fadeOut(1000, function () {
...
// collaps 
var coll = document.getElementsByClassName("cole");
var i;
