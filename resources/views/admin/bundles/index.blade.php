        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{route('admin.bundles.create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        $(document).ready(function() {
            const dataTable = $('#myTable').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "bundle_start", width: "25%", searchable: false, orderable: false, "class": "text-left"},
                    { "data": "bundle_end", width: "25%", searchable: false, orderable: false, "class": "text-left"},
